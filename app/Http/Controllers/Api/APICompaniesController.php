...
class APICompaniesController extends BaseApiController
{
    ...
    public function show(Request $request)
    {
        if($request->has('company_id'))
        {
            ...
            $companyInfo      = $this->repository->model->with(['company_all_providers', 'company_all_providers.provider.user', 'company_providers', 'company_providers.provider', 'company_services', 'company_testimonials', 'company_services', 'company_services.service'])
            ->where('id', $companyId)
            ->first();
