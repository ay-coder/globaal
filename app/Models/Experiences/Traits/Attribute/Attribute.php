<?php namespace App\Models\Experiences\Traits\Attribute;
...
use App\Repositories\Experiences\EloquentExperiencesRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentExperiencesRepository;
