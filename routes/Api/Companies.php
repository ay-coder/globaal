...
Route::group(['namespace' => 'Api'], function()
{
    ...
    Route::post('company/search-providers', 'APICompaniesController@searchProviders')->name('companies.search-providers');
    ...
    Route::post('companies-with-distance', 'APICompaniesController@getCompaniesWithDistances')->name('companies.companies');
    ...
    Route::post('companies/provider-filter', 'APICompaniesController@filter')->name('companies.filter');
});
?>
